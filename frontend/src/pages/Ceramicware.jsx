...
const Ceramicware = () => {
  ...
  const { ceramicProducts = [], search, showSearch } = useContext(ShopContext);
  ...
  useEffect(() => {
    const title = formatFilterTitle(subcategory) || "Ceramicware";
  ...
  const applyFilter = () => {
    ...
    const filtered = base.filter((item) => {
      ...
      //Best Seller & Premium Collection Filters
