...
const Product = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{productData.name} | M Crystal</title>

        {/* Open Graph */}
        <meta property="og:title" content={productData.name} />
        <meta property="og:description" content={productData.tagline} />
        ...
        <meta name="twitter:description" content={productData.tagline} />
              ...
              <div>
                <div className="flex flex-col justify-start gap-3">
                  <div className="flex gap-2 justify-start items-center">
                    <p className="text-red-600 text-xl mt-5">
                      -{offerPercent}%
                    </p>
          ...
          <div className="mt-20">
            ...
            <div className="flex flex-col gap-4 border border-gray-200 px-6 py-6 text-sm text-gray-500">
              ...
              <p>
                ...
                product reflects quality and care. We focus on durability,
                beauty, and meaningful details in every creation. M Crystal
                Store helps you transform spaces into refined, graceful
                experiences.
              </p>
            </div>
          </div>
