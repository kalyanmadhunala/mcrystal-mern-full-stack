...
const SignUp = () => {
  ...
  const { bannerState, navigate, setLogin, getUserData, setCartData, getUserCart } = useContext(ShopContext);
  ...
  useEffect(() => {
    // block back ONLY for section 3
    if (!sectionThreeVisible) return;
...
useEffect(() => {
  ...
  /* Handle Register (Section 2 → Section 3) */
  ...
  useEffect(() => {
    ...
    return () => clearInterval(timer);
  }, [sectionThreeVisible, otpTimeLeft]);
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="flex flex-col justify-end lg:justify-end lg:mr-16 lg:flex-row items-center lg:items-center w-full">
          ...
          >
            ...
            {sectionOneVisible && (
              <div>
                <p className="text-xs text-center allura-regular text-primary">
                  Signup
                </p>
                  ...
                  {password && confirm && (
                    <p
                      className={`ml-2 text-sm mt-1 ${
                        password !== confirm ? "text-red-500" : "text-green-500"
                      }`}
                    >
                      Passwords{" "}
                      {password !== confirm ? "do not match" : "match"}
                    </p>
                  )}
